...
              className="flex h-16 w-10 items-center justify-center text-4xl font-bold text-white sm:h-20 sm:w-14 sm:text-5xl md:h-28 md:w-24 md:text-7xl font-mono leading-none"
            >
              {digit}
            </div>
          ))}
